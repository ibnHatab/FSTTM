...
func init() {
	typemap.RegisterMessage("unitree_go/UwbState", UwbStateTypeSupport)
	typemap.RegisterMessage("unitree_go/msg/UwbState", UwbStateTypeSupport)
}
...
func (t *UwbState) CloneMsg() types.Message {
	return t.Clone()
}
...
func (t *UwbState) GetTypeSupport() types.MessageTypeSupport {
	return UwbStateTypeSupport
}

// UwbStatePublisher wraps rclgo.Publisher to provide type safe helper
// functions
...
// UwbState
func NewUwbStatePublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*UwbStatePublisher, error) {
	pub, err := node.NewPublisher(topic_name, UwbStateTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// UwbStateSubscription wraps rclgo.Subscription to provide type safe helper
// functions
...
type UwbStateSubscriptionCallback func(msg *UwbState, info *rclgo.MessageInfo, err error)

// NewUwbStateSubscription creates and returns a new subscription for the
// UwbState
func NewUwbStateSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback UwbStateSubscriptionCallback) (*UwbStateSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg UwbState
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topic_name, UwbStateTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *UwbStateSubscription) TakeMessage(out *UwbState) (*rclgo.MessageInfo, error) {
...
var UwbStateTypeSupport types.MessageTypeSupport = _UwbStateTypeSupport{}

type _UwbStateTypeSupport struct{}

func (t _UwbStateTypeSupport) New() types.Message {
	return NewUwbState()
}
...
func (t _UwbStateTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	m := msg.(*UwbState)
	mem := (*C.unitree_go__msg__UwbState)(dst)
	cSlice_version := mem.version[:]
	primitives.Uint8__Array_to_C(*(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_version)), m.Version[:])
	...
	primitives.Float32__Array_to_C(*(*[]primitives.CFloat32)(unsafe.Pointer(&cSlice_joystick)), m.Joystick[:])
	mem.error_state = C.uint8_t(m.ErrorState)
	mem.buttons = C.uint8_t(m.Buttons)
	mem.enabled_from_app = C.uint8_t(m.EnabledFromApp)
}

func (t _UwbStateTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*UwbState)
	mem := (*C.unitree_go__msg__UwbState)(ros2_message_buffer)
	cSlice_version := mem.version[:]
	primitives.Uint8__Array_to_Go(m.Version[:], *(*[]primitives.CUint8)(unsafe.Pointer(&cSlice_version)))
	...
	cSlice_joystick := mem.joystick[:]
	primitives.Float32__Array_to_Go(m.Joystick[:], *(*[]primitives.CFloat32)(unsafe.Pointer(&cSlice_joystick)))
...
type CUwbState__Sequence = C.unitree_go__msg__UwbState__Sequence

func UwbState__Sequence_to_Go(goSlice *[]UwbState, cSlice CUwbState__Sequence) {
	if cSlice.size == 0 {
		return
	}
...
func UwbState__Sequence_to_C(cSlice *CUwbState__Sequence, goSlice []UwbState) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func UwbState__Array_to_Go(goSlice []UwbState, cSlice []CUwbState) {
	for i := 0; i < len(cSlice); i++ {
		UwbStateTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func UwbState__Array_to_C(cSlice []CUwbState, goSlice []UwbState) {
