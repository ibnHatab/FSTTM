...
func init() {
	typemap.RegisterMessage("unitree_go/SportModeState", SportModeStateTypeSupport)
	typemap.RegisterMessage("unitree_go/msg/SportModeState", SportModeStateTypeSupport)
}
...
func (t *SportModeState) CloneMsg() types.Message {
	return t.Clone()
}
...
func (t *SportModeState) GetTypeSupport() types.MessageTypeSupport {
	return SportModeStateTypeSupport
}

// SportModeStatePublisher wraps rclgo.Publisher to provide type safe helper
// functions
...
// SportModeState
func NewSportModeStatePublisher(node *rclgo.Node, topic_name string, options *rclgo.PublisherOptions) (*SportModeStatePublisher, error) {
	pub, err := node.NewPublisher(topic_name, SportModeStateTypeSupport, options)
	if err != nil {
		return nil, err
	}
...
// SportModeStateSubscription wraps rclgo.Subscription to provide type safe helper
// functions
...
type SportModeStateSubscriptionCallback func(msg *SportModeState, info *rclgo.MessageInfo, err error)

// NewSportModeStateSubscription creates and returns a new subscription for the
// SportModeState
func NewSportModeStateSubscription(node *rclgo.Node, topic_name string, opts *rclgo.SubscriptionOptions, subscriptionCallback SportModeStateSubscriptionCallback) (*SportModeStateSubscription, error) {
	callback := func(s *rclgo.Subscription) {
		var msg SportModeState
		info, err := s.TakeMessage(&msg)
		subscriptionCallback(&msg, info, err)
	}
	sub, err := node.NewSubscription(topic_name, SportModeStateTypeSupport, opts, callback)
	if err != nil {
		return nil, err
	}
...
func (s *SportModeStateSubscription) TakeMessage(out *SportModeState) (*rclgo.MessageInfo, error) {
...
var SportModeStateTypeSupport types.MessageTypeSupport = _SportModeStateTypeSupport{}

type _SportModeStateTypeSupport struct{}

func (t _SportModeStateTypeSupport) New() types.Message {
...
func (t _SportModeStateTypeSupport) AsCStruct(dst unsafe.Pointer, msg types.Message) {
	...
	primitives.Float32__Array_to_C(*(*[]primitives.CFloat32)(unsafe.Pointer(&cSlice_range_obstacle)), m.RangeObstacle[:])
	...
	primitives.Float32__Array_to_C(*(*[]primitives.CFloat32)(unsafe.Pointer(&cSlice_foot_position_body)), m.FootPositionBody[:])
	cSlice_foot_speed_body := mem.foot_speed_body[:]
	primitives.Float32__Array_to_C(*(*[]primitives.CFloat32)(unsafe.Pointer(&cSlice_foot_speed_body)), m.FootSpeedBody[:])
}

func (t _SportModeStateTypeSupport) AsGoStruct(msg types.Message, ros2_message_buffer unsafe.Pointer) {
	m := msg.(*SportModeState)
	...
	cSlice_range_obstacle := mem.range_obstacle[:]
	primitives.Float32__Array_to_Go(m.RangeObstacle[:], *(*[]primitives.CFloat32)(unsafe.Pointer(&cSlice_range_obstacle)))
	cSlice_foot_force := mem.foot_force[:]
	primitives.Int16__Array_to_Go(m.FootForce[:], *(*[]primitives.CInt16)(unsafe.Pointer(&cSlice_foot_force)))
	cSlice_foot_position_body := mem.foot_position_body[:]
	primitives.Float32__Array_to_Go(m.FootPositionBody[:], *(*[]primitives.CFloat32)(unsafe.Pointer(&cSlice_foot_position_body)))
	cSlice_foot_speed_body := mem.foot_speed_body[:]
	primitives.Float32__Array_to_Go(m.FootSpeedBody[:], *(*[]primitives.CFloat32)(unsafe.Pointer(&cSlice_foot_speed_body)))
}
...
type CSportModeState__Sequence = C.unitree_go__msg__SportModeState__Sequence

func SportModeState__Sequence_to_Go(goSlice *[]SportModeState, cSlice CSportModeState__Sequence) {
	if cSlice.size == 0 {
		return
	}
...
func SportModeState__Sequence_to_C(cSlice *CSportModeState__Sequence, goSlice []SportModeState) {
	if len(goSlice) == 0 {
		cSlice.data = nil
		cSlice.capacity = 0
		cSlice.size = 0
...
func SportModeState__Array_to_Go(goSlice []SportModeState, cSlice []CSportModeState) {
	for i := 0; i < len(cSlice); i++ {
		SportModeStateTypeSupport.AsGoStruct(&goSlice[i], unsafe.Pointer(&cSlice[i]))
	}
}
func SportModeState__Array_to_C(cSlice []CSportModeState, goSlice []SportModeState) {
